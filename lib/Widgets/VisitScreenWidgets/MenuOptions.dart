...
import 'package:aiDvantage/Widgets/VisitScreenWidgets/BusinessMappingForm.dart';
                  ...
                  children: [
                    Lottie.asset(
                      ...
                      Padding(
                        ...
                        child: Text("Create business mapping", style: GoogleFonts.lato(
                     ...
                     child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: Text("route plan statistics",
                          ...
                          Padding(
                            ...
                            child: Text("Pending route plans: 456",
                            style: GoogleFonts.lato(
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: size.width*0.03),
                            child: Text("Accompolished route plans: 120",
                            style: GoogleFonts.lato(
                              fontSize:size.width*0.03,
                              color: AppColors.contentColorBlack,
                            ),
                          ...
                          Center(
                            child: Text("Total route plans: 120",
                            style: GoogleFonts.lato(
                              fontWeight: FontWeight.bold,
                              fontSize:size.width*0.038,
                              color: AppColors.contentColorBlack,
