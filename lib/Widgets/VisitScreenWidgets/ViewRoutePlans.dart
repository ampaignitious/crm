...
import 'package:aiDvantage/Widgets/VisitScreenWidgets/SingleRouteViewScreen.dart';
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text("route name", style: GoogleFonts.lato(
                    ),))),
                  Container(
                    margin: EdgeInsets.only(left: size.width*0.01),
                    height: size.height*0.06,
          ...
          child: Row(
            children: [
              ...
              Container(
                    ...
                    child: Center(child: Text("${visitData.age}", style: GoogleFonts.lato(
                      color:Colors.black
                    ),
...
class VisitData {
  ...
  VisitData(this.id, this.name, this.age);
}