...
class AvailableCoffeeProductsDisplayScreen extends StatefulWidget {
  ...
  @override
  State<AvailableCoffeeProductsDisplayScreen> createState() => _AvailableCoffeeProductsDisplayScreenState();
}
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text("Coffee product page",
            ...
            Tab(
              child: Row(children: [
                ...
                Padding(
                  ...
                  child: Text("Available coffee catergories: 20", style: GoogleFonts.lato(
        ...
        Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                labelText: 'Search the coffee product by name',
